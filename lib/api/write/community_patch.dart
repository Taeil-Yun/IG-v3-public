...
class CommunityWritingPatchAPI {
  Future<CommunityWritingPatchAPIResponseModel> patch({
    ...
    if (type == 'S' || type == 'A') {
      ...
      request.fields['community_index'] = '$communityIndex';
      if (title.isNotEmpty) {
    ...
    if (response.statusCode == 200) {
      ...
      return CommunityWritingPatchAPIResponseModel.fromJson(
      ...
      return RefreshTokenAPI()
          ...
          .then((value) {
        return CommunityWritingPatchAPI().patch(
...
class CommunityWritingPatchAPIResponseModel {
  dynamic result;

  CommunityWritingPatchAPIResponseModel({
    this.result,
  });

  factory CommunityWritingPatchAPIResponseModel.fromJson(
      Map<dynamic, dynamic> data) {
    return CommunityWritingPatchAPIResponseModel(
      result: data,
    );
  }
}
